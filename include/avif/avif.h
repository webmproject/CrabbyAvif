...
constexpr static const uint32_t AVIF_STRICT_EXIF_VALID = (1 << 3);

constexpr static const uint32_t AVIF_STRICT_MULTIPLE_ILOC_ENTRIES_FOR_SAME_ITEM_DISALLOWED = (1 << 4);

constexpr static const uint32_t AVIF_STRICT_HEVC_BRAND_REQUIRES_MOOV = (1 << 5);

constexpr static const uint32_t AVIF_STRICT_ENABLED = (((((AVIF_STRICT_PIXI_REQUIRED | AVIF_STRICT_CLAP_VALID) | AVIF_STRICT_ALPHA_ISPE_REQUIRED) | AVIF_STRICT_EXIF_VALID) | AVIF_STRICT_MULTIPLE_ILOC_ENTRIES_FOR_SAME_ITEM_DISALLOWED) | AVIF_STRICT_HEVC_BRAND_REQUIRES_MOOV);

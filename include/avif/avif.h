...
constexpr static const uint32_t AVIF_STRICT_ENABLED = ((((AVIF_STRICT_PIXI_REQUIRED | AVIF_STRICT_CLAP_VALID) | AVIF_STRICT_ALPHA_ISPE_REQUIRED) | AVIF_STRICT_EXIF_VALID) | AVIF_STRICT_MULTIPLE_ILOC_ENTRIES_FOR_SAME_ITEM_DISALLOWED);

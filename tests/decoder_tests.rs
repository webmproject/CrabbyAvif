...
use crabby_avif::decoder::ImageContentTypeFlag;
...
fn color_grid_gainmap_different_grid() {
    ...
    decoder.settings.image_content_to_decode = vec![
...
fn decode_ignore_color_and_alpha() {
    let mut decoder = get_decoder("seine_sdr_gainmap_srgb.avif");
    decoder.settings.image_content_to_decode = vec![ImageContentTypeFlag::GainMap];
